    ...
    <div className="max-w-[960px] mx-auto px-6 py-12">
      ...
      <div className="flex items-start gap-3 bg-[#FFF8F0] border border-gold-light rounded-2xl p-4 mb-8">
        ...
        <p className="text-[13px] text-ink-secondary font-light leading-relaxed">
          练习期间请勿按 <code className="font-mono text-xs bg-[rgba(212,165,116,0.15)] px-1.5 py-0.5 rounded">⌘Q</code>{' '}
          或 <code className="font-mono text-xs bg-[rgba(212,165,116,0.15)] px-1.5 py-0.5 rounded">⌘W</code>，
